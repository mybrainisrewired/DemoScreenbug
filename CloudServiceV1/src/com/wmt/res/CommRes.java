...
public final class CommRes {
        ...
        try {
            ...
            synchronized (sInnerClassMap) {
                if (sContext != null) {
                    ...
                    sContext = context.createPackageContext(PACKAGE_COMMRES, ItemAnimation.CUR_ALPHA);
    ...
    public static int getResourceResId(Context context, String strId) {
        ...
        int innerDot = strId.indexOf(".", ItemAnimation.CUR_Z);
        String innerClass = strId.substring(ItemAnimation.CUR_Z, innerDot);
