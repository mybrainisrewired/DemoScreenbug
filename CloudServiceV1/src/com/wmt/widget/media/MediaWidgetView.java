...
public class MediaWidgetView extends LinearLayout implements OnItemClickListener, ContentListener {
    ...
    class DeviceLoadingTask extends AsyncTask<Integer, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            if (!MediaWidgetView.this.mIsOnDetached) {
                ...
                MediaWidgetView.this.mProgress.setVisibility(GLView.FLAG_POPUP);
                if (this.mCount > 0) {
                    MediaWidgetView.this.mEmpty.setVisibility(GLView.FLAG_POPUP);
                    if (MediaWidgetView.this.mType != 0) {
    ...
    private void openStorage() {
        ...
        this.mEmpty.setVisibility(GLView.FLAG_POPUP);
        this.mSingleView.setVisibility(GLView.FLAG_POPUP);
