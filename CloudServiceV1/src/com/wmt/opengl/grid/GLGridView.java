...
public class GLGridView extends GLView {
    ...
    private FloatBuffer calculateColorsBuffer(float color, FloatBuffer buffer, int site) {
        ...
        float point4 = 1.0f;
        if (buffer == null) {
            ByteBuffer bb = ByteBuffer.allocateDirect(MediaObject.SUPPORT_FULL_IMAGE);
    ...
    private void onDrawBackground(GLCanvas glCanvas, int left, int top, boolean forceDrawSth) {
        if (this.mBackGroundID != -1) {
            ...
            this.mGLGridBackgroundDrawer.draw(glCanvas, this.mRealRect.left + left, this.mRealRect.top + top, (int)ItemAnimation.CUR_ARC);
                ...
                if (index < count) {
                    ...
                    if (this.mCrossfadeRatio >= 0.0f && this.mSlideMode != 1) {
                        ...
                        if (-1 != crossfadeDirection) {
                            ...
                            gl.glColorPointer(ItemAnimation.CUR_ARC, 5126, SLIDE_MODE_PLANE, this.mColorsBuffer);
                        }
                    }
    ...
    public boolean onKeyDown(KeyEvent event) {
        ...
        if (this.mItemFocused < startIndex || this.mItemFocused >= endIndex) {
            ...
            switch (event.getKeyCode()) {
                ...
                case KeyTouchInputEvent.ABS_MT_WIDTH_MINOR:
                ...
                case MediaObject.SUPPORT_SETAS:
