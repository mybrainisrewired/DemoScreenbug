    ...
    public class MusicListAdapter extends SimpleCursorAdapter {
            ...
            try {
                ...
                if (pos < 0 || MusicUtils.sService.duration() <= 0) {
                    ...
                    if (MusicUtils.sService.isPlaying()) {
                        ...
                        this.mCurrentTime.setVisibility(this.mCurrentTime.getVisibility() == 4 ? 0 : ItemAnimation.CUR_ARC);
                        remaining = 500;
                    }
        ...
        public void changeCursor(Cursor cursor) {
            if (cursor == null || cursor.getCount() <= 0) {
                ...
                ListMusicView.this.mList.setVisibility(ItemAnimation.CUR_ARC);
            } else {
                ...
                ListMusicView.this.mEmpty.setVisibility(GLView.FLAG_POPUP);
