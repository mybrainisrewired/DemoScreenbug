...
public class MusicUtils {
    ...
    public static void setSpinnerState(Activity a) {
        if (isMediaScannerScanning(a)) {
            a.getWindow().setFeatureInt(FragmentManagerImpl.ANIM_STYLE_FADE_ENTER, -3);
            a.getWindow().setFeatureInt(FragmentManagerImpl.ANIM_STYLE_FADE_ENTER, -1);
        } else {
            a.getWindow().setFeatureInt(FragmentManagerImpl.ANIM_STYLE_FADE_ENTER, PagerAdapter.POSITION_NONE);
        }
    }
