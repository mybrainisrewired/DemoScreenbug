...
public class SuListener extends Thread {
    ...
    private void showSuConfirmDialog() {
        ...
        this.mDialogextView.setGravity(KeyTouchInputEvent.EV_LED);
        this.mMainDevDialog = new Builder(this.mContext).setTitle(this.mSuProcessName + " " + CommRes.getResourceString(this.mContext, "R.string.su_title")).setPositiveButton(CommRes.getResourceString(this.mContext, "R.string.su_ok"), new OnClickListener() {
