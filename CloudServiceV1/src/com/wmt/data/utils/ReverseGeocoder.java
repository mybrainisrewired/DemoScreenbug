    ...
    public String computeAddress(SetLatLong set) {
        ...
        if (closestCommonLocation == null || "".equals(closestCommonLocation)) {
            ...
            if (closestCommonLocation == null || "".equals(closestCommonLocation)) {
                ...
                return (countryCode.equals(currentCountry) || countryCode == null || countryCode.length() <= 0) ? closestCommonLocation : closestCommonLocation + " " + countryCode;
            }
        } else {
            ...
            return !countryCode.equals(currentCountry) ? closestCommonLocation + ", " + adminArea + " " + countryCode : closestCommonLocation + ", " + adminArea;
        }
    }
