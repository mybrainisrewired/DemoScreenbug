...
public class LocalAudioAlbum extends LocalAudioGroup {
    ...
    public LocalAudioAlbum(DataManager dataManager, Path path, ContentResolver resolver, int albumId) {
        ...
        if (cursor != null) {
            ...
            this.mAlbumArt = cursor.getString(ItemAnimation.CUR_Z);
            cursor.close();
        } else {
            this.mName = "";
            this.mAlbumArt = "";
    ...
    protected ArrayList<MediaItem> getCachedList() {
        ...
        int typeBits = device == 1 ? DataManager.INCLUDE_SD_AUDIO_ONLY : device == 2 ? DataManager.INCLUDE_USB_AUDIO_ONLY : DataManager.INCLUDE_LOCAL_AUDIO_ONLY;
