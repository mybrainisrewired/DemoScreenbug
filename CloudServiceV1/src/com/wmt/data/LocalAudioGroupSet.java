        ...
        try {
            ...
            if (this.mGroupType == 1) {
                ...
                while (cursor.moveToNext()) {
                    ...
                    artistName = cursor.getString(ItemAnimation.CUR_Z);
                ...
                while (cursor.moveToNext()) {
                    ...
                    String artistKey = cursor.getString(ItemAnimation.CUR_Z);
                ...
                if (this.mGroupType == 3) {
                    ...
                    if (cursor == null) {
                        ...
                        while (cursor.moveToNext()) {
                            ...
                            String playlistData = cursor.getString(ItemAnimation.CUR_Z);
