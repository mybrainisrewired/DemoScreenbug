...
public class ServerAcceptedChannelSelector extends Thread {
    ...
    void doAccept(SelectionKey key) throws IOException {
        ...
        bab.append(EventPacket.intToByteArray((int)KeyTouchInputEvent.KEY_HOME), 0, EventPacket.BYTES_PER_INT);
    ...
    void startAccept() throws IOException {
        ...
        this.mAcceptKey = ssc.register(this.mSelector, MmInfo.MMINFO_MEM_SIZE);
