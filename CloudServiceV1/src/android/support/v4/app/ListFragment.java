...
public class ListFragment extends Fragment {
        ...
        if (this.mList == null) {
            ...
            if (root instanceof ListView) {
                ...
                if (this.mStandardEmptyView == null) {
                    ...
                    this.mStandardEmptyView.setVisibility(GLView.FLAG_POPUP);
                }
    ...
    private void setListShown(boolean shown, boolean animate) {
        ...
        if (this.mProgressContainer == null) {
            ...
            if (shown) {
                ...
                this.mProgressContainer.setVisibility(GLView.FLAG_POPUP);
                ...
                this.mListContainer.setVisibility(GLView.FLAG_POPUP);
            }
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        pframe.setVisibility(GLView.FLAG_POPUP);
        pframe.setGravity(KeyTouchInputEvent.EV_LED);
        ...
        tv.setGravity(KeyTouchInputEvent.EV_LED);
