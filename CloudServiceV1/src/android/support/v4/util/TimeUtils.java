    ...
    private static int formatDurationLocked(long duration, int fieldLen) {
        ...
        if (duration == 0) {
            ...
            if (fieldLen != 0) {
                ...
                myLen += accumField(hours, 1, myLen > 0, ItemAnimation.CUR_Z);
                myLen += accumField(minutes, 1, myLen > 0, ItemAnimation.CUR_Z);
                myLen += accumField(seconds, 1, myLen > 0, ItemAnimation.CUR_Z);
                myLen += accumField(millis, ItemAnimation.CUR_Z, true, myLen > 0 ? ItemAnimation.CUR_ALPHA : 0) + 1;
            ...
            pos = printField(formatStr, hours, 'h', pos, pos != start, zeropad ? ItemAnimation.CUR_Z : 0);
            pos = printField(formatStr, minutes, 'm', pos, pos != start, zeropad ? ItemAnimation.CUR_Z : 0);
            pos = printField(formatStr, seconds, 's', pos, pos != start, zeropad ? ItemAnimation.CUR_Z : 0);
            int i = (!zeropad || pos == start) ? 0 : ItemAnimation.CUR_ALPHA;
