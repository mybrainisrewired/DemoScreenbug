...
public class ListFragment extends Fragment {
        ...
        if (this.mList == null) {
            ...
            if (root instanceof ListView) {
                ...
                if (this.mStandardEmptyView == null) {
                    ...
                    this.mStandardEmptyView.setVisibility(Type.DOUBLE);
                }
    ...
    private void setListShown(boolean shown, boolean animate) {
        ...
        if (this.mProgressContainer == null) {
            ...
            if (shown) {
                ...
                this.mProgressContainer.setVisibility(Type.DOUBLE);
                ...
                this.mListContainer.setVisibility(Type.DOUBLE);
            }
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        pframe.setVisibility(Type.DOUBLE);
        pframe.setGravity(Opcodes.SIPUSH);
