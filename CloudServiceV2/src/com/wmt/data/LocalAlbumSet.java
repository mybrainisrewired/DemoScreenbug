    ...
    private MediaSet getLocalAlbum(int type, Path parent, int id, String name) {
        ...
        switch (type) {
            ...
            case FragmentManagerImpl.ANIM_STYLE_FADE_EXIT:
                ...
                return new LocalMergeAlbum(path, comp, new MediaSet[]{getLocalAlbum(INDEX_BUCKET_NAME, path2, id, name), getLocalAlbum(JsonWriteContext.STATUS_EXPECT_VALUE, path3, id, name)});
            default:
