...
public class GLView {
    ...
    final void dispatchCancelEvent() {
        ...
        MotionEvent cancelEvent = MotionEvent.obtain(now, now, JsonWriteContext.STATUS_OK_AFTER_SPACE, 0.0f, 0.0f, ZORDER_NORMAL);
    ...
    protected boolean dispatchTouchEvent(MotionEvent event) {
        ...
        if (this.mMotionTarget == null || action != 0) {
            ...
            cancel.setAction(JsonWriteContext.STATUS_OK_AFTER_SPACE);
            ...
            if (action == 0) {
                ...
                while (i >= 0) {
                    ...
                    if (child.isFlagSet(JsonWriteContext.STATUS_OK_AFTER_SPACE) && dispatchTouchEvent(event, x, y, child, true)) {
