...
public class WmtSurfaceView extends SurfaceView implements Callback, OnClickListener, OnLongClickListener, WmtScrollerListener {
        ...
        void drawBackground(Canvas canvas) {
            ...
            if (WmtSurfaceView.this.mBgBmp != null) {
                ...
                if (WmtSurfaceView.this.mBackgroundMode == 0) {
                    if (WmtSurfaceView.this.mSurfaceViewMode == 0) {
                        num = bgW >= thisW ? ClassWriter.COMPUTE_FRAMES : thisW / bgW + 1;
                        ...
                        num = bgH >= thisH ? ClassWriter.COMPUTE_FRAMES : thisH / bgH + 1;
                        i = SURFACEVIEW_HORIZONTAL;
                        while (i < num) {
                    ...
                    num = bgW >= thisW ? ClassWriter.COMPUTE_FRAMES : thisW / bgW + 2;
                    ...
                    num = bgH >= thisH ? ClassWriter.COMPUTE_FRAMES : thisH / bgH + 2;
    ...
    public WmtSurfaceView(Context context) {
        super(context);
        this.mBgColor = Color.argb(MotionEventCompat.ACTION_MASK, Opcodes.DLOAD, Opcodes.DLOAD, Opcodes.DLOAD);
