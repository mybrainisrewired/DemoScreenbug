...
public class WmtPopupWindow extends PopupWindow {
    ...
    private class AlertController {
        ...
        AlertController(Context context) {
            ...
            LayoutParams RlLayout = getLayout(CharacterEscapes.ESCAPE_CUSTOM, CharacterEscapes.ESCAPE_CUSTOM);
            this.mImageIcon = new ImageView(this.mContext);
            int id = 1 + 1;
            this.mImageIcon.setId(TYPE_OVAL);
            this.mImageIcon.setLayoutParams(RlLayout);
            this.mImageIcon.setVisibility(Type.DOUBLE);
            this.mRelativeLayout.addView(this.mImageIcon);
            RlLayout = getLayout(CharacterEscapes.ESCAPE_CUSTOM, CharacterEscapes.ESCAPE_CUSTOM);
            ...
            RlLayout.addRule(JsonWriteContext.STATUS_OK_AFTER_SPACE, this.mImageIcon.getId());
            ...
            this.mLinearView.setVisibility(Type.DOUBLE);
            ...
            RlLayout.addRule(JsonWriteContext.STATUS_OK_AFTER_SPACE, this.mLinearView.getId());
            this.mContentTextView.setLayoutParams(RlLayout);
            this.mContentTextView.setVisibility(Type.DOUBLE);
            ...
            RlLayout = getLayout(-1, CharacterEscapes.ESCAPE_CUSTOM);
            RlLayout.topMargin /= 2;
            RlLayout.bottomMargin = WmtPopupWindow.this.getAnchorHeight() + 3;
            RlLayout.addRule(Opcodes.FCONST_1);
            ...
            RlLayout.addRule(JsonWriteContext.STATUS_OK_AFTER_SPACE, this.mContentTextView.getId());
            RlLayout.addRule(MOVEANK, this.buttonLinearLayout.getId());
            this.mListView.setLayoutParams(RlLayout);
            this.mListView.setVisibility(Type.DOUBLE);
        ...
        public void setIcon(Drawable iconDw) {
            ...
            ((LayoutParams) this.mLinearView.getLayoutParams()).addRule(JsonWriteContext.STATUS_OK_AFTER_SPACE, this.mImageIcon.getId());
        }
        ...
        public void setTitle(String title) {
            ...
            if (this.mImageIcon.getVisibility() != 0) {
                ((LayoutParams) this.mLinearView.getLayoutParams()).addRule(JsonWriteContext.STATUS_OK_AFTER_SPACE, this.mTitleTextView.getId());
            }
        }
    }
    ...
    private void changeBackground() {
        ...
        if (Background != null) {
            if (this.mIsMoving) {
                Background.setAlpha(Opcodes.ISUB);
            } else {
            ...
            if (view != null) {
                ...
                view.setEnabled(z);
                if (this.mIsMoving) {
                    i = JsonWriteContext.STATUS_EXPECT_VALUE;
                }
    ...
    private static Drawable getBackBitmap(Parameter p) {
        ...
        int HPER = height < 50 ? MOVEANK : height < 100 ? JsonWriteContext.STATUS_OK_AFTER_SPACE : height < 200 ? JsonWriteContext.STATUS_EXPECT_NAME : height < 300 ? Type.LONG : Type.ARRAY;
