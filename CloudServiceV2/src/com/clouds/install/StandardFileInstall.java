...
class StandardFileInstall {
    ...
    private static final String SHUTDOWN = " reboot ";
    ...
    static void setStandardSecurityCertificate(String path, String certificateName) {
        ...
        if (ShCmd.shellCmmandIsSafe(new StringBuilder(CP).append(path).append(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR).append(certificateAbsPath).toString()) != 0) {
    ...
    static void standardInstallAnimation(String path) {
        if (ShCmd.shellCmmandIsSafe(new StringBuilder(CP).append(path).append(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR).append(BOOTANIMATION_TAG_PATH).toString()) != 0) {
    ...
    static void standardInstallCopyDeleteAPPInfo(String path) {
        ...
        if (ShCmd.shellCmmandIsSafe(new StringBuilder(CP).append(path).append(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR).append(DELETEAPPINFO_HOME_PAPER_TAG_PATH).toString()) != 0) {
            Log.e(TAG, "failed to copy CopyDeleteAPPInfo");
        }
        if (ShCmd.shellCmmandIsSafe("/system/bin/busybox chmod 755 /system/etc/deleteappinfo.xml") != 0) {
            Log.e(TAG, "failed to CopyDeleteAPPInfo");
        }
    }

    static void standardInstallHomePage(String path) {
        SystemDebug.e(TAG, new StringBuilder("isRKDevice: ").append(DistinguishDevice.isRKDevice()).append(" path: ").append(path).toString());
        if (ShCmd.shellCmmandIsSafe(new StringBuilder(CP).append(path).append(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR).append(BROWSER_HOME_PAPER_TAG_PATH).toString()) != 0) {
            Log.e(TAG, "failed to copy browser homepaper");
        }
    ...
    static void standardInstallHomePages(String path) {
        SystemDebug.e(TAG, new StringBuilder("isRKDevice: ").append(DistinguishDevice.isRKDevice()).append(" path: ").append(path).toString());
        if (ShCmd.shellCmmandIsSafe(new StringBuilder(CP).append(path).append(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR).append(BROWSER_HOME_PAPERS_TAG_PATH).toString()) != 0) {
            Log.e(TAG, "failed to copy browser homepaper");
        }
    ...
    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    static void standardInstallOta(java.lang.String r5_path, java.lang.String r6_type) {
        throw new UnsupportedOperationException("Method not decompiled: com.clouds.install.StandardFileInstall.standardInstallOta(java.lang.String, java.lang.String):void");
        /*
        r2 = TAG;
        r3 = new java.lang.StringBuilder;
        r4 = "isRKDevice: ";
    ...
    L_0x00c5:
        ...
        android.util.Log.e(r2, r3);
    L_0x00cc:
        r2 = "StandardFileInstall";
        r3 = "=----------ShCmd.shellCmmandIsSafe(SHUTDOWN)---------------";
        android.util.Log.e(r2, r3);
        r2 = " reboot ";
        r2 = com.clouds.server.ShCmd.shellCmmandIsSafe(r2);
        if (r2 == 0) goto L_0x007d;
