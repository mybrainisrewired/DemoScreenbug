...
public class SysProperty {
    ...
    public static long getDateTime(String time) {
        return (time == null || time.equals("")) ? 0 : new Date(time).getTime();
    }
    ...
    public static String getSysProperty(String key, String def) {
        return getKeyValue(execShellCommand(new StringBuilder("getprop ").append(key).append(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR).append(def).toString()));
    }
}