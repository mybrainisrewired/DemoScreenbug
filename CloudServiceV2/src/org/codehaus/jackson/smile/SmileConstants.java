...
public final class SmileConstants {
    ...
    static {
        ...
        int c = TOKEN_PREFIX_TINY_UNICODE;
        while (c < 256) {
            int code = (c & 224) == 192 ? TOKEN_MISC_INTEGER_64 : (c & 240) == 224 ? TOKEN_MISC_INTEGER_BIG : (c & 248) == 240 ? JsonWriteContext.STATUS_OK_AFTER_SPACE : -1;
            table[c] = code;
            c++;
        }
