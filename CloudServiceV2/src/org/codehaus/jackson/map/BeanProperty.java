...
public interface BeanProperty {
    ...
    public static class Std implements BeanProperty {
        ...
        public org.codehaus.jackson.map.BeanProperty.Std withType(JavaType type) {
            return new org.codehaus.jackson.map.BeanProperty.Std(this._name, type, this._contextAnnotations, this._member);
        }
    }
