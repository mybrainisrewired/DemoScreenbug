                ...
                while (i < entries.size()) {
                    ...
                    if (!receiver.broadcasting) {
                        ...
                        if (match >= 0) {
                            ...
                            String reason;
                            switch (match) {
                                case InvalidManifestConfigException.MISSING_CONFIG_KEYBOARD:
                                    reason = "category";
                                    break;
                                case InvalidManifestConfigException.MISSING_CONFIG_CHANGES:
                                    reason = OrmmaView.ACTION_KEY;
                                    break;
                                case InvalidManifestConfigException.MISSING_ACTIVITY_DECLARATION:
                                    reason = IMBrowserActivity.EXPANDDATA;
                                    break;
                                case TimedEvent.SC_NO_RESPONSE:
                                    reason = AnalyticsSQLiteHelper.EVENT_LIST_TYPE;
                                    break;
                                default:
