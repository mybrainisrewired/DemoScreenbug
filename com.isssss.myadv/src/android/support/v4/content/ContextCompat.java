...
public class ContextCompat {
    ...
    public static File[] getExternalCacheDirs(Context context) {
        ...
        if (version >= 8) {
            ...
            single = buildPath(Environment.getExternalStorageDirectory(), new String[]{DIR_ANDROID, DIR_DATA, context.getPackageName(), DIR_CACHE});
        }
    ...
    public static File[] getExternalFilesDirs(Context context, String type) {
        ...
        if (version >= 8) {
            ...
            single = buildPath(Environment.getExternalStorageDirectory(), new String[]{DIR_ANDROID, DIR_DATA, context.getPackageName(), DIR_FILES, type});
        }
        return new File[]{single};
    }
    ...
    public static File[] getObbDirs(Context context) {
        ...
        if (version >= 11) {
            ...
            single = buildPath(Environment.getExternalStorageDirectory(), new String[]{DIR_ANDROID, DIR_OBB, context.getPackageName()});
        }
        return new File[]{single};
    }
