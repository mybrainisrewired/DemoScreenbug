...
class RemoteInputCompatJellybean {
    ...
    static Bundle getResultsFromIntent(Intent intent) {
        ...
        return (clipDescription.hasMimeType("text/vnd.android.intent") && clipDescription.getLabel().equals(RESULTS_CLIP_LABEL)) ? (Bundle) clipData.getItemAt(0).getIntent().getExtras().getParcelable(EXTRA_RESULTS_DATA) : null;
    }
