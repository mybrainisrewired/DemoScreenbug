    ...
    public static abstract class Stub extends Binder implements INotificationSideChannel {
        ...
        private static class Proxy implements INotificationSideChannel {
            ...
            public void cancel(String packageName, int id, String tag) throws RemoteException {
                ...
                this.mRemote.transact(TRANSACTION_cancel, _data, null, TRANSACTION_notify);
                _data.recycle();
            }
            ...
            public void cancelAll(String packageName) throws RemoteException {
                ...
                _data.writeInterfaceToken(DESCRIPTOR);
                _data.writeString(packageName);
                this.mRemote.transact(TRANSACTION_cancelAll, _data, null, TRANSACTION_notify);
                _data.recycle();
            }
            ...
            public void notify(String packageName, int id, String tag, Notification notification) throws RemoteException {
                ...
                this.mRemote.transact(TRANSACTION_notify, _data, null, TRANSACTION_notify);
                _data.recycle();
            }
        }
        ...
        public static INotificationSideChannel asInterface(IBinder obj) {
            ...
            return (iin == null || !iin instanceof INotificationSideChannel) ? new Proxy(obj) : (INotificationSideChannel) iin;
        }
