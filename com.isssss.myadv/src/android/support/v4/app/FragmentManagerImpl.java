    ...
    public void hideFragment(Fragment fragment, int transition, int transitionStyle) {
        ...
        if (!fragment.mHidden) {
            ...
            if (fragment.mView != null) {
                ...
                fragment.mView.setVisibility(ApiEventType.API_MRAID_SET_ORIENTATION_PROPERTIES);
            }
    ...
    Animation loadAnimation(Fragment fragment, int transit, boolean enter, int transitionStyle) {
        ...
        switch (styleIndex) {
            case ANIM_STYLE_OPEN_ENTER:
                return makeOpenCloseAnimation(this.mActivity, 1.125f, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, BitmapDescriptorFactory.HUE_RED, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
            case ANIM_STYLE_OPEN_EXIT:
                return makeOpenCloseAnimation(this.mActivity, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, 0.975f, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, BitmapDescriptorFactory.HUE_RED);
            case ANIM_STYLE_CLOSE_ENTER:
                return makeOpenCloseAnimation(this.mActivity, 0.975f, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, BitmapDescriptorFactory.HUE_RED, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
            case ANIM_STYLE_CLOSE_EXIT:
                return makeOpenCloseAnimation(this.mActivity, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, 1.075f, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, BitmapDescriptorFactory.HUE_RED);
            case ANIM_STYLE_FADE_ENTER:
                return makeFadeAnimation(this.mActivity, BitmapDescriptorFactory.HUE_RED, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
            case ANIM_STYLE_FADE_EXIT:
                return makeFadeAnimation(this.mActivity, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, BitmapDescriptorFactory.HUE_RED);
            default:
