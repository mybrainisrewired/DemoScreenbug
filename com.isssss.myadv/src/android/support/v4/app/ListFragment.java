...
public class ListFragment extends Fragment {
        ...
        if (this.mList == null) {
            ...
            if (root instanceof ListView) {
                ...
                if (this.mStandardEmptyView == null) {
                    ...
                    this.mStandardEmptyView.setVisibility(ApiEventType.API_MRAID_SET_ORIENTATION_PROPERTIES);
                }
    ...
    private void setListShown(boolean shown, boolean animate) {
        ...
        if (this.mProgressContainer == null) {
            ...
            if (shown) {
                ...
                this.mProgressContainer.setVisibility(ApiEventType.API_MRAID_SET_ORIENTATION_PROPERTIES);
                ...
                this.mListContainer.setVisibility(ApiEventType.API_MRAID_SET_ORIENTATION_PROPERTIES);
            }
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        pframe.setVisibility(ApiEventType.API_MRAID_SET_ORIENTATION_PROPERTIES);
        pframe.setGravity(ApiEventType.API_MRAID_GET_SCREEN_SIZE);
        ...
        tv.setGravity(ApiEventType.API_MRAID_GET_SCREEN_SIZE);
