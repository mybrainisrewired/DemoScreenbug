...
public abstract class CursorAdapter extends BaseAdapter implements Filterable, CursorFilterClient {
    ...
    public CharSequence convertToString(Cursor cursor) {
        return cursor == null ? Preconditions.EMPTY_ARGUMENTS : cursor.toString();
    }
    ...
    void init(Context context, Cursor c, int flags) {
        ...
        this.mRowIDColumn = cursorPresent ? c.getColumnIndexOrThrow(PushIdsTable.COLUMN_ID) : -1;
        if ((flags & 2) == 2) {
    ...
    public Cursor swapCursor(Cursor newCursor) {
        ...
        if (newCursor != null) {
            ...
            this.mRowIDColumn = newCursor.getColumnIndexOrThrow(PushIdsTable.COLUMN_ID);
