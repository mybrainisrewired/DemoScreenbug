...
class TransportMediatorJellybeanMR2 implements OnGetPlaybackPositionListener, OnPlaybackPositionUpdateListener {
    ...
    public void pausePlaying() {
        if (this.mPlayState == 3) {
            this.mPlayState = 2;
            this.mRemoteControl.setPlaybackState(MMAdView.TRANSITION_UP);
        }
        dropAudioFocus();
    }
    ...
    public void refreshState(boolean playing, long position, int transportControls) {
        if (this.mRemoteControl != null) {
            this.mRemoteControl.setPlaybackState(playing ? 3 : 1, position, playing ? DefaultRetryPolicy.DEFAULT_BACKOFF_MULT : BitmapDescriptorFactory.HUE_RED);
    ...
    public void startPlaying() {
        if (this.mPlayState != 3) {
            this.mPlayState = 3;
            this.mRemoteControl.setPlaybackState(MMAdView.TRANSITION_DOWN);
        }
        if (this.mFocused) {
            takeAudioFocus();
        }
    ...
    void takeAudioFocus() {
        if (!this.mAudioFocused) {
            ...
            this.mAudioManager.requestAudioFocus(this.mAudioFocusChangeListener, MMAdView.TRANSITION_DOWN, 1);
        }
    }
