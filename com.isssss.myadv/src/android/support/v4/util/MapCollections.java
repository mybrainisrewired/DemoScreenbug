...
abstract class MapCollections<K, V> {
    ...
    final class EntrySet implements Set<Entry<K, V>> {
        ...
        public boolean contains(Object o) {
            ...
            return index >= 0 ? ContainerHelpers.equal(MapCollections.this.colGetEntry(index, 1), e.getValue()) : false;
        }
    ...
    public static <T> boolean equalsSetHelper(Set<T> set, Set<T> object) {
        boolean z = 1;
        if (set == object) {
            return true;
        }
