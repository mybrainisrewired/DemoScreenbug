...
public class AndroidAuthenticator implements Authenticator {
    ...
    public String getAuthToken() throws AuthFailureError {
        ...
        try {
            ...
            if (future.isDone() && !future.isCancelled() && result.containsKey("intent")) {
            ...
            throw new AuthFailureError(new StringBuilder("Got null auth token for type: ").append(this.mAuthTokenType).toString());
        } catch (Exception e) {
