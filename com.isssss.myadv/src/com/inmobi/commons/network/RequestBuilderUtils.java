...
public class RequestBuilderUtils {
    ...
    private static String a(Calendar calendar) {
        return calendar != null ? calendar.get(1) + "-" + (calendar.get(MMAdView.TRANSITION_UP) + 1) + "-" + calendar.get(ApiEventType.API_MRAID_GET_ORIENTATION_PROPERTIES) : null;
    }
    ...
    public static void fillIdentityMap(Map<String, Object> map, Map<String, Boolean> map2, boolean z) {
        if (map != null) {
            map.put(KEY_MK_SITE_ID, InMobi.getAppId());
            ...
            if (!(DeviceInfo.getPhoneDefaultUserAgent() == null || Preconditions.EMPTY_ARGUMENTS.equals(DeviceInfo.getPhoneDefaultUserAgent()))) {
            ...
            map.put(AdTrackerConstants.TIMESTAMP, Long.valueOf(instance.getTimeInMillis()));
            map.put("tz", Integer.valueOf(instance.get(ApiEventType.API_MRAID_GET_ORIENTATION) + instance.get(ApiEventType.API_MRAID_GET_PLACEMENT_TYPE)));
