...
public class AdTrackerNetworkInterface {
    ...
    private static void a(String str, Goal goal) {
        ...
        String goalName = goal.getGoalName();
        if (h()) {
            valueOf = Boolean.valueOf(reportUsingNetwork(str, goal));
        } else {
            valueOf = Boolean.valueOf(reportUsingWebview(str, goal));
        }
    ...
    private static boolean h() {
        ...
        try {
            ...
            instance.add(ApiEventType.API_MRAID_EXPAND, Integer.parseInt(preferences));
    ...
    private static void k() throws CommonsException {
