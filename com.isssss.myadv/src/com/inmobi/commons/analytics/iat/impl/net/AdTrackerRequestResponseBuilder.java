...
public class AdTrackerRequestResponseBuilder {
    ...
    protected static String formHTTPRequest(String str, String str2, int i, boolean z, String str3) {
        ...
        if (!(str == null || str.trim().equals(Preconditions.EMPTY_ARGUMENTS))) {
            linkedList.add(new BasicNameValuePair(RequestBuilderUtils.KEY_MK_SITE_ID, str));
        }
        ...
        if (!(str2 == null || str2.trim().equals(Preconditions.EMPTY_ARGUMENTS))) {
        ...
        if (!(str4 == null || str4.trim().equals(Preconditions.EMPTY_ARGUMENTS))) {
            linkedList.add(new BasicNameValuePair(AdTrackerConstants.APPVER, str4));
        }
        if (!(str3 == null || str3.trim().equals(Preconditions.EMPTY_ARGUMENTS))) {
