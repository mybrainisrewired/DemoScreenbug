        ...
        try {
            if (!(SessionInfo.getSessionId(this.a) == null || this.b == null)) {
                ...
                try {
                    ...
                    analyticsEvent.setTransactionProductId(jSONObject.getString(ParamConst.PRODUCT_ID));
        ...
        try {
            if (this.c.getInt("RESPONSE_CODE") == 0) {
                ...
                while (i < stringArrayList.size()) {
                    ...
                    String string = jSONObject.getString(ParamConst.PRODUCT_ID);
                    ...
                    String optString2 = jSONObject.optString(BannerInfoTable.COLUMN_TITLE);
                    String optString3 = jSONObject.optString(BannerInfoTable.COLUMN_DESCRIPTION);
