...
public class AnalyticsUtils {
    public static final String ANALYTICS_LOGGING_TAG = "[InMobi]-[Analytics]-4.5.0";
    ...
    public static Object getCountryISO(Context context) {
        ...
        if (telephonyManager.getNetworkCountryIso().equals(Preconditions.EMPTY_ARGUMENTS)) {
            try {
        ...
        return (iSO3Country == null || iSO3Country.equals(Preconditions.EMPTY_ARGUMENTS)) ? null : iSO3Country;
    }
    ...
    public static synchronized String getMaxevents() {
        String str;
        synchronized (AnalyticsUtils.class) {
            str = AnalyticsInitializer.getConfigParams().getGetParamsLimit() + Preconditions.EMPTY_ARGUMENTS;
        }
        return str;
    }
    ...
    public static String getScreenHeight(Context context) {
        return Preconditions.EMPTY_ARGUMENTS + context.getResources().getDisplayMetrics().heightPixels;
    }

    public static String getScreenWidth(Context context) {
        return Preconditions.EMPTY_ARGUMENTS + context.getResources().getDisplayMetrics().widthPixels;
    }
