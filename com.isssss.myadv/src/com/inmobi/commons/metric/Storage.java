...
public class Storage {
    ...
    private void a() {
        try {
            FileOperations.writeStringToFile(InternalSDKUtil.getContext(), this.c, Preconditions.EMPTY_ARGUMENTS + this.h, false);
            FileOperations.writeStringToFile(InternalSDKUtil.getContext(), this.d, Preconditions.EMPTY_ARGUMENTS + this.i, false);
        } catch (Exception e) {
            this.h = 0;
        }
    }
    ...
    public void resetFile() {
        try {
            FileOperations.writeStringToFile(InternalSDKUtil.getContext(), this.b, Preconditions.EMPTY_ARGUMENTS, false);
            this.h = 0;
            this.i = System.currentTimeMillis() / 1000;
            a();
        } catch (IOException e) {
    ...
    public void sendFile() {
        ...
        try {
            ...
            jSONObject.put("tz", instance.get(ApiEventType.API_MRAID_GET_PLACEMENT_TYPE));
