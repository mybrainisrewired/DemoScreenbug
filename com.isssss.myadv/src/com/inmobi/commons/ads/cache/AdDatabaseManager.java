...
public class AdDatabaseManager {
    ...
    public synchronized AdData getAd(String str) {
        ...
        try {
            ...
            adData.setAppId(rawQuery.getString(MMAdView.TRANSITION_UP));
            adData.setContent(rawQuery.getString(MMAdView.TRANSITION_DOWN));
            rawQuery.close();
    ...
    public synchronized void insertAd(AdData adData) {
        try {
            ...
            contentValues.put(ClickDatabaseManager.COLUMN_TIMESTAMP, Long.valueOf(adData.getTimestamp()));
