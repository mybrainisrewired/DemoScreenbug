...
public class Base64 {
    ...
    static class c extends b {
        ...
        public c(int i, byte[] bArr) {
            ...
            this.j = new byte[2];
            this.c = 0;
            this.k = this.e ? Encoder.LINE_GROUPS : -1;
        }
...
*/
    ...
    public static byte[] decode(byte[] bArr, int i, int i2, int i3) {
        a aVar = new a(i3, new byte[((i2 * 3) / 4)]);
        if (!aVar.a(bArr, i, i2, true)) {
            throw new IllegalArgumentException("bad base-64");
        } else if (aVar.b == aVar.a.length) {
            return aVar.a;
        } else {
            byte[] bArr2 = new byte[aVar.b];
            System.arraycopy(aVar.a, DEFAULT, bArr2, DEFAULT, aVar.b);
            return bArr2;
        }
    }
