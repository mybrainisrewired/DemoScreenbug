...
public final class WifiUtil {
    ...
    public static WifiInfo getConnectedWifiInfo(Context context) {
        ...
        return getConnectedWifiInfo(context, !ThinICEConfigSettings.bitTest(wifiFlags, MMAdView.TRANSITION_UP), ThinICEConfigSettings.bitTest(wifiFlags, 1));
    }
    ...
    public static long macToLong(String str) {
        ...
        int i = 0;
        while (i < 6) {
            bArr[i] = (byte) Integer.parseInt(split[i], ApiEventType.API_MRAID_GET_ORIENTATION);
            i++;
        }
        return a(bArr);
    }
