...
public class IMAIClickEventList extends ArrayList<ClickData> {
    ...
    public ClickData getClickEvent(long j) {
        ...
        try {
            ...
            Log.internal(InvalidManifestErrorMessages.LOGGING_TAG, "Cant get click event", e);
            return clickData;
        }
    }
    ...
    public synchronized void reduceRetryCount(int i) {
        try {
            ...
            Log.internal(InvalidManifestErrorMessages.LOGGING_TAG, "Cant reduce retry count", e);
        }
    }
    ...
    public synchronized boolean removeClickEvent(long j) {
        ...
        synchronized (this) {
            try {
                ...
                Log.internal(InvalidManifestErrorMessages.LOGGING_TAG, "Cant remove click event", e);
            }
        }
        return z;
    }
    ...
    public void saveClickEvents() {
        Log.internal(InvalidManifestErrorMessages.LOGGING_TAG, "Save ping events");
