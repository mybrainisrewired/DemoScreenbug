...
public class MRAIDExpandController {
    ...
    private void a(ViewGroup viewGroup, boolean z) {
        ...
        int i = (z || this.a.getCustomClose()) ? ApiEventType.API_MRAID_SET_ORIENTATION_PROPERTIES : 0;
    ...
    public void doExpand(Bundle bundle) {
        ...
        try {
            ...
            try {
                ...
                intent.putExtra(IMBrowserActivity.EXTRA_BROWSER_ACTIVITY_TYPE, LocationRequest.PRIORITY_BALANCED_POWER_ACCURACY);
