...
public class AVPlayer extends VideoView implements OnCompletionListener, OnErrorListener, OnPreparedListener {
    ...
    private void c() {
        throw new UnsupportedOperationException("Method not decompiled: com.inmobi.re.controller.util.AVPlayer.c():void");
        /*
        r2 = this;
        r0 = r2.r;
        r1 = com.inmobi.re.controller.util.AVPlayer.playerState.SHOWING;
        if (r0 != r1) goto L_0x0012;
    L_0x0006:
        r0 = r2.m;
        if (r0 == 0) goto L_0x000f;
    L_0x000a:
        r0 = com.inmobi.re.controller.util.AVPlayer.playerState.COMPLETED;
    L_0x000c:
        r2.r = r0;
    L_0x000e:
        return;
    L_0x000f:
        r0 = com.inmobi.re.controller.util.AVPlayer.playerState.PAUSED;
        goto L_0x000c;
    L_0x0012:
        r0 = r2.a;
        r0 = r0.isAutoPlay();
    ...
    L_0x001a:
        r0 = r2.r;
        r1 = com.inmobi.re.controller.util.AVPlayer.playerState.INIT;
    ...
    public void hide() {
        try {
            ...
            this.u.setVisibility(MMAdView.TRANSITION_RANDOM);
    ...
    public void setPlayData(PlayerProperties playerProperties, String str) {
        ...
        this.c = a(this.c);
        if (this.o == null) {
            this.o = Bitmap.createBitmap(ApiEventType.API_MRAID_USE_CUSTOM_CLOSE, ApiEventType.API_MRAID_USE_CUSTOM_CLOSE, Config.ARGB_8888);
            if (VERSION.SDK_INT >= 8) {
                try {
