...
public abstract class JSController {
    ...
    public static class Dimensions extends com.inmobi.re.controller.JSController.ReflectedParcelable {
        public static final Creator<com.inmobi.re.controller.JSController.Dimensions> CREATOR;
        public int height;
        public int width;
        public int x;
        public int y;
    ...
    public static class ExpandProperties extends com.inmobi.re.controller.JSController.ReflectedParcelable {
        public static final Creator<com.inmobi.re.controller.JSController.ExpandProperties> CREATOR;
        ...
        public void reinitializeExpandProperties() {
            ...
            this.rotationAtExpand = Preconditions.EMPTY_ARGUMENTS;
            this.currentX = 0;
            this.currentY = 0;
        }
    }
    ...
    public static class OrientationProperties extends com.inmobi.re.controller.JSController.ReflectedParcelable {
        public static final Creator<com.inmobi.re.controller.JSController.OrientationProperties> CREATOR;
        ...
        public void initializeOrientationProperties() {
            ...
            this.forceOrientation = Preconditions.EMPTY_ARGUMENTS;
        }
    }

    public static class PlayerProperties extends com.inmobi.re.controller.JSController.ReflectedParcelable {
        public static final Creator<com.inmobi.re.controller.JSController.PlayerProperties> CREATOR;
        ...
        public PlayerProperties() {
            ...
            this.stopStyle = str;
            this.startStyle = str;
            this.id = Preconditions.EMPTY_ARGUMENTS;
        }
    ...
    public static class Properties extends com.inmobi.re.controller.JSController.ReflectedParcelable {
        public static final Creator<com.inmobi.re.controller.JSController.Properties> CREATOR;
    ...
    public static class ResizeProperties extends com.inmobi.re.controller.JSController.ReflectedParcelable {
        public static final Creator<com.inmobi.re.controller.JSController.ResizeProperties> CREATOR;
                        ...
                        if (toString.startsWith("#")) {
                            ...
                            try {
                                if (toString.startsWith("#0x")) {
                                    i2 = Integer.decode(toString.substring(1)).intValue();
                                } else {
                                    i2 = Integer.parseInt(toString.substring(1), ApiEventType.API_MRAID_GET_ORIENTATION);
                                }
