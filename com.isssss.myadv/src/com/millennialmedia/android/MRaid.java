...
class MRaid {
    ...
    static class AnonymousClass_1 implements Runnable {
        ...
        public void run() {
            Finished fin;
            try {
                MMLog.w(TAG, "MMJS -  download start (" + this.val$url + ")");
                HttpResponse response = new DefaultHttpClient().execute(new HttpGet(this.val$url));
                MMLog.w(TAG, "MMJS -  download finish (" + this.val$url + ")");
                if (MRaid.saveMRaid(this.val$context, response.getEntity().getContent()) && MRaid.storeMraidUrl(this.val$context, this.val$url)) {
                    MMLog.w(TAG, "MMJS -  download saved (" + this.val$url + ")");
                }
                if (finishedRef != null) {
                    fin = (Finished) finishedRef.get();
                    if (fin == null) {
                        return;
                    }
                    fin.finished();
                ...
                MMLog.e(TAG, "Mraid download exception: ", e);
                if (finishedRef != null) {
                    fin = finishedRef.get();
                    if (fin == null) {
                    }
                ...
                MMLog.e(TAG, "Mraid download exception: ", e2);
                if (finishedRef != null) {
                    fin = finishedRef.get();
                    if (fin == null) {
                    }
                ...
                MMLog.e(TAG, "Mraid download exception: ", e3);
                if (finishedRef != null) {
                    fin = finishedRef.get();
                    if (fin == null) {
                    }
    ...
    static void downloadMraidJs(Context context, String url) {
        if (!TextUtils.isEmpty(url)) {
            ThreadUtils.execute(new AnonymousClass_1(url, context));
        }
    }

    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    static java.lang.String getMMJSStats(android.content.Context r22_context) {
    ...
    static String getPreviousUrl(Context context) {
        return context != null ? context.getSharedPreferences("MillennialMediaSettings", 0).getString(KEY_MMJS_URL, Preconditions.EMPTY_ARGUMENTS) : Preconditions.EMPTY_ARGUMENTS;
    }
    ...
    static String injectMraidJs(Context context, String content) {
        ...
        return content.indexOf("<html>") == -1 ? "<html><head></head><body style='margin:0;padding:0;'>" + content + "</body></html>" : content;
    }

    static boolean isMRaidAd(String content) {
        return content == null ? false : Pattern.compile(MRAID_JS_REPLACE_PATTERN).matcher(content).find();
    }
    ...
    static boolean isMRaidUpdated(Context context, String mmjsUrl) {
        ...
        return hasMraidLocally && mmjsUrl.equals(previousUrl);
    }
    ...
    static boolean saveIncludedMMJS(Context context, String mmjsUrl) {
        ...
        return saveMRaid(context, new ByteArrayInputStream(mmjsComplete)) && storeMraidUrl(context, mmjsUrl);
    }

    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    static boolean saveMRaid(android.content.Context r11_context, java.io.InputStream r12_is) {
        throw new UnsupportedOperationException("Method not decompiled: com.millennialmedia.android.MRaid.saveMRaid(android.content.Context, java.io.InputStream):boolean");
        /*
        r6 = 1;
        r7 = 0;
        r2 = new java.io.File;
        r8 = com.millennialmedia.android.AdCache.getInternalCacheDirectory(r11);
        r9 = "mraid.js";
        r2.<init>(r8, r9);
        r8 = "MRaid";
        r9 = "Saving mraid js to %s";
        r10 = new java.lang.Object[r6];
        r10[r7] = r2;
        r9 = java.lang.String.format(r9, r10);
        com.millennialmedia.android.MMLog.v(r8, r9);
        r4 = 0;
        r5 = new java.io.FileOutputStream;	 Catch:{ Exception -> 0x0072 }
        r5.<init>(r2);	 Catch:{ Exception -> 0x0072 }
        r8 = 1024; // 0x400 float:1.435E-42 double:5.06E-321;
        r0 = new byte[r8];	 Catch:{ Exception -> 0x0038, all -> 0x006f }
    L_0x0026:
        r3 = r12.read(r0);	 Catch:{ Exception -> 0x0038, all -> 0x006f }
    ...
    L_0x0033:
        r8 = 0;
        r5.write(r0, r8, r3);	 Catch:{ Exception -> 0x0038, all -> 0x006f }
        goto L_0x0026;
    L_0x0038:
        r1 = move-exception;
        r4 = r5;
    ...
    L_0x003c:
        r2.delete();	 Catch:{ all -> 0x004d }
    L_0x003f:
        r6 = "MRaid";
        r8 = "Exception downloading component mraid.js: ";
        com.millennialmedia.android.MMLog.e(r6, r8, r1);	 Catch:{ all -> 0x004d }
    ...
    L_0x005d:
        ...
        r6 = "MRaid";
        r8 = "Exception closing file: ";
        com.millennialmedia.android.MMLog.e(r6, r8, r1);
        goto L_0x004b;
    L_0x0066:
        r1 = move-exception;
        r7 = "MRaid";
