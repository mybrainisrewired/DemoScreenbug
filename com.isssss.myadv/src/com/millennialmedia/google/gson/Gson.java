...
public final class Gson {
    ...
    public <T> T fromJson(JsonElement json, Type classOfT) throws JsonSyntaxException {
        return Primitives.wrap(classOfT).cast(fromJson(json, classOfT));
    }

    public <T> T fromJson(JsonElement json, Type typeOfT) throws JsonSyntaxException {
        return json == null ? null : fromJson(new JsonTreeReader(json), typeOfT);
    }
    ...
    public <T> T fromJson(Reader json, Type classOfT) throws JsonSyntaxException, JsonIOException {
    ...
    public <T> T fromJson(String json, Type typeOfT) throws JsonSyntaxException {
        return json == null ? null : fromJson(new StringReader(json), typeOfT);
    }
    ...
    public <T> TypeAdapter<T> getAdapter(TypeToken<T> type) {
        ...
        try {
            ...
            while (i$.hasNext()) {
                TypeAdapter<T> candidate = ((TypeAdapterFactory) i$.next()).create(this, type);
                if (candidate != null) {
    ...
    public <T> TypeAdapter<T> getAdapter(Class type) {
    ...
    public String toJson(Object src) {
        return src == null ? toJson(JsonNull.INSTANCE) : toJson(src, src.getClass());
    }
