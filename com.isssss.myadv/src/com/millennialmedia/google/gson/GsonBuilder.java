...
import com.millennialmedia.google.gson.internal._$Gson;
...
public final class GsonBuilder {
    ...
    private void addTypeAdaptersForDate(String datePattern, int dateStyle, int timeStyle, List<TypeAdapterFactory> factories) {
        ...
        if (datePattern != null && !Preconditions.EMPTY_ARGUMENTS.equals(datePattern.trim())) {
    ...
    public GsonBuilder setExclusionStrategies(ExclusionStrategy... strategies) {
        ...
        int i$ = 0;
        while (i$ < len$) {
            this.excluder = this.excluder.withExclusionStrategy(arr$[i$], true, true);
            i$++;
        }
        return this;
    }
