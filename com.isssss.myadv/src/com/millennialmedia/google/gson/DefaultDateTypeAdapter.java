...
final class DefaultDateTypeAdapter implements JsonSerializer<Date>, JsonDeserializer<Date> {
    ...
    DefaultDateTypeAdapter() {
        this(DateFormat.getDateTimeInstance(MMAdView.TRANSITION_UP, MMAdView.TRANSITION_UP, Locale.US), DateFormat.getDateTimeInstance(MMAdView.TRANSITION_UP, MMAdView.TRANSITION_UP));
    }
