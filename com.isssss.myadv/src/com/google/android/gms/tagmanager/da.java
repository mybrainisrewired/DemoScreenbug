...
class da implements ab {
    ...
    da(HttpClient httpClient, Context context, a aVar) {
        ...
        this.aat = a("GoogleTagManager", "4.00", VERSION.RELEASE, b(Locale.getDefault()), Build.MODEL, Build.ID);
        this.aau = httpClient;
        this.aav = aVar;
    }
    ...
    private HttpEntityEnclosingRequest a(URL url) {
        ...
        try {
            ...
            try {
                ...
                bh.z("Exception sending hit: " + uRISyntaxException.getClass().getSimpleName());
            ...
            bh.z("Exception sending hit: " + uRISyntaxException2.getClass().getSimpleName());
            bh.z(uRISyntaxException2.getMessage());
            return basicHttpEntityEnclosingRequest;
        }
        return basicHttpEntityEnclosingRequest;
    }
    ...
    public void d(java.util.List<com.google.android.gms.tagmanager.ap> r11) {
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.tagmanager.da.d(java.util.List):void");
        /*
        r10 = this;
        r3 = 0;
        r0 = r11.size();
    ...
    L_0x001b:
        ...
        com.google.android.gms.tagmanager.bh.z(r2);
        r2 = r10.aav;
        r2.b(r0);
        r0 = r1;
    L_0x0026:
    ...
    L_0x0057:
        r2 = r10.aac;	 Catch:{ ClientProtocolException -> 0x00a3, IOException -> 0x00b1 }
        com.google.android.gms.tagmanager.bn.p(r2);	 Catch:{ ClientProtocolException -> 0x00a3, IOException -> 0x00b1 }
        r1 = r3;
    L_0x005d:
        r2 = r10.aau;	 Catch:{ ClientProtocolException -> 0x00a3, IOException -> 0x00b1 }
    ...
    L_0x0078:
        ...
        com.google.android.gms.tagmanager.bh.z(r2);	 Catch:{ ClientProtocolException -> 0x00a3, IOException -> 0x00b1 }
        r2 = r10.aav;	 Catch:{ ClientProtocolException -> 0x00a3, IOException -> 0x00b1 }
    ...
    L_0x00b1:
        ...
        r6 = r6.append(r7);
        r6 = r6.toString();
        com.google.android.gms.tagmanager.bh.z(r6);
        r2 = r2.getMessage();
        com.google.android.gms.tagmanager.bh.z(r2);
        r2 = r10.aav;
        r2.c(r0);
