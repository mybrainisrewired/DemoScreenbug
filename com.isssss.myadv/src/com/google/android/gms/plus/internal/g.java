...
public final class g {
    ...
    private static c D(Context context) throws a {
        ...
        if (Uj == null) {
            ...
            try {
                Uj = com.google.android.gms.plus.internal.c.a.aP((IBinder) Sz.getClassLoader().loadClass("com.google.android.gms.plus.plusone.PlusOneButtonCreatorImpl").newInstance());
    ...
    L_0x000f:
        ...
        r1 = com.google.android.gms.dynamic.e.h(r6);	 Catch:{ Exception -> 0x0008 }
        r2 = r7;
        r3 = r8;
        r4 = r9;
        r5 = r10;
        r0 = r0.a(r1, r2, r3, r4, r5);	 Catch:{ Exception -> 0x0008 }
        r0 = com.google.android.gms.dynamic.e.d(r0);	 Catch:{ Exception -> 0x0008 }
