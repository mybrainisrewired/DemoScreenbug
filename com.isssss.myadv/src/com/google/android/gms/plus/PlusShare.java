...
public final class PlusShare {
    ...
    public static class Builder {
        ...
        public com.google.android.gms.plus.PlusShare.Builder addCallToAction(String label, Uri uri, String deepLinkId) {
            ...
            fq.b(z, (Object)"Must provide a call to action URL");
            Bundle bundle = new Bundle();
            if (!TextUtils.isEmpty(label)) {
                bundle.putString(KEY_CALL_TO_ACTION_LABEL, label);
            }
            ...
            if (!TextUtils.isEmpty(deepLinkId)) {
                ...
                bundle.putString(KEY_CALL_TO_ACTION_DEEP_LINK_ID, deepLinkId);
            }
        ...
        public com.google.android.gms.plus.PlusShare.Builder addStream(Uri streamUri) {
        ...
        public Intent getIntent() {
            boolean z = true;
            int i = this.Ua != null && this.Ua.size() > 1;
            ...
            boolean z2 = i == 0 || !booleanExtra;
            fq.a(z2, "Call-to-action buttons are only available for URLs.");
            z2 = !booleanExtra || this.mIntent.hasExtra(EXTRA_CONTENT_URL);
            fq.a(z2, "The content URL is required for interactive posts.");
            ...
            if (this.mIntent.hasExtra(EXTRA_CONTENT_DEEP_LINK_ID)) {
                fq.a(PlusShare.bd(this.mIntent.getStringExtra(EXTRA_CONTENT_DEEP_LINK_ID)), "The specified deep-link ID was malformed.");
            }
            if (i == 0 && equals) {
        ...
        public com.google.android.gms.plus.PlusShare.Builder setContentDeepLinkId(String deepLinkId) {
            return setContentDeepLinkId(deepLinkId, null, null, null);
        }

        public com.google.android.gms.plus.PlusShare.Builder setContentDeepLinkId(String deepLinkId, String title, String description, Uri thumbnailUri) {
            fq.b(this.TZ, (Object)"Must include the launching activity with PlusShare.Builder constructor before setting deep links");
            fq.b(!TextUtils.isEmpty(deepLinkId), (Object)"The deepLinkId parameter is required.");
            Bundle a = PlusShare.a(title, description, thumbnailUri);
            this.mIntent.putExtra(EXTRA_CONTENT_DEEP_LINK_ID, deepLinkId);
        ...
        public com.google.android.gms.plus.PlusShare.Builder setRecipients(Person user, List<Person> recipientList) {
            this.mIntent.putExtra(EXTRA_SENDER_ID, user != null ? user.getId() : "0");
            return setRecipients(recipientList);
        }

        @Deprecated
        public com.google.android.gms.plus.PlusShare.Builder setRecipients(List<Person> recipientList) {
        ...
        public com.google.android.gms.plus.PlusShare.Builder setStream(Uri streamUri) {
            this.Ua = null;
            this.mIntent.putExtra("android.intent.extra.STREAM", streamUri);
            return this;
        }

        public com.google.android.gms.plus.PlusShare.Builder setText(CharSequence text) {
            this.mIntent.putExtra("android.intent.extra.TEXT", text);
            return this;
        }

        public com.google.android.gms.plus.PlusShare.Builder setType(String mimeType) {
