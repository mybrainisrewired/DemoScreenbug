...
import com.google.android.gms.internal.ih.a;
import com.millennialmedia.android.MMAdView;
import java.util.HashSet;
import java.util.Set;

public class ij implements Creator<a> {
    static void a(a aVar, Parcel parcel, int i) {
        ...
        if (ja.contains(Integer.valueOf(MMAdView.TRANSITION_UP))) {
            b.c(parcel, MMAdView.TRANSITION_UP, aVar.getMax());
        }
        if (ja.contains(Integer.valueOf(MMAdView.TRANSITION_DOWN))) {
            b.c(parcel, MMAdView.TRANSITION_DOWN, aVar.getMin());
        }
        b.F(parcel, p);
    }

    public a aO(Parcel parcel) {
        int i = 0;
