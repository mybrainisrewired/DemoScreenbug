...
(function() {
	...
	//VservAdControllerInterface.showMsg('document.readyState');
	...
	var EventListeners = function(event) {
		console.log("^^^^^^^^^^^^ormma_A-AN-2.0.1.js inside EventListeners from ormma.js:");
		this.event = event;
		this.count = 0;
		var listeners = {};
		...
		this.add = function(func) {
			var id = String(func);
			if (!listeners[id]) {
				console.log("ormma_A-AN-2.0.1.js inside EventListeners activate from ormma.js:");
				listeners[id] = func;
				this.count++;
				if (this.count == 1)
		...
		this.remove = function(func) {
			var id = String(func);
			if (listeners[id]) {
				console.log("ormma_A-AN-2.0.1.js inside EventListeners deactivate from ormma.js:");
				listeners[id] = null;
				delete listeners[id];
				this.count--;
				if (this.count == 0)
	...
	ormmaview.addEventListener('error', function(message, action) {
		console.log("ormma_A-AN-2.0.1.js inside ormmaview.addEventListener error from ormma.js:");
	...
	ormmaview
			.addEventListener(
					...
					function(uri, response) {
						console
								.log("ormma_A-AN-2.0.1.js inside ormmaview.addEventListener response from ormma.js:");
	...
	ormmaview
			.addEventListener(
					...
					function(alias, URL) {
						console
								.log("ormma_A-AN-2.0.1.js inside ormmaview.addEventListener assetReady from ormma.js:");
						assets[alias] = URL;
	...
	ormmaview
			.addEventListener(
					...
					function(alias) {
						console
								.log("ormma_A-AN-2.0.1.js inside ormmaview.addEventListener assetRemoved from ormma.js:");
						assets[alias] = null;
						delete assets[alias];
	...
	ormmaview
			.addEventListener(
					...
					function(alias) {
						console
								.log("ormma_A-AN-2.0.1.js inside ormmaview.addEventListener assetRetired from ormma.js:");
						assets[alias] = null;
						delete assets[alias];
	...
	var trim = function(s) {
		console.log("ormma_A-AN-2.0.1.js inside trim from ormma.js:");
		var l = 0;
		var r = s.length - 1;
	...
	ormma.addEventListener = function(event, listener) {
		console.log("ormma_A-AN-2.0.1.js inside ormma.addEventListener from ormma.js:");
		if (!event || !listener) {
			broadcastEvent(EVENTS.ERROR,
	...
	ormma.close = function() {
		console.log("ormma_A-AN-2.0.1.js inside ormma.close from ormma.js:");
		ormmaview.close();
	};
	
	ormma.expand = function(dimensions, URL) {
		console.log("ormma_A-AN-2.0.1.js inside ormma.expand from ormma.js:");
	...
	ormma.getDefaultPosition = function() {
		console.log("ormma_A-AN-2.0.1.js inside ormma.getDefaultPosition from ormma.js:");
		return clone(defaultPosition);
	};

	ormma.getExpandProperties = function() {
		console.log("ormma_A-AN-2.0.1.js inside ormma.getExpandProperties from ormma.js:");
		return clone(ormmaview.getExpandProperties());
	};

	ormma.getMaxSize = function() {
		console.log("ormma_A-AN-2.0.1.js inside ormma.getMaxSize from ormma.js:");
		return clone(maxSize);
	};

	ormma.getSize = function() {
		console.log("!!!!ormma_A-AN-2.0.1.js inside ormma.getSize from ormma.js:");
		return clone(size);
	};

	ormma.getState = function() {
		console.log("ormma_A-AN-2.0.1.js inside ormma.getState from ormma.js:");
		return state;
	};

	ormma.hide = function() {
		console.log("ormma_A-AN-2.0.1.js inside ormma.hide from ormma.js:");
	...
	ormma.open = function(URL, controls) {
		console.log("ormma_A-AN-2.0.1.js inside ormma.open from ormma.js:");
		if (!URL) {
	...
	ormma.setExpandProperties = function(properties) {
		console.log("ormma_A-AN-2.0.1.js inside ormma.setExpandProperties from ormma.js:");
	...
	ormma.show = function() {
		console.log("ormma_A-AN-2.0.1.js inside ormma.show from ormma.js:");
		if (state != STATES.HIDDEN) {
	...
	ormma.playAudio = function(URL, properties) {
		console.log("ormma_A-AN-2.0.1.js inside ormma.playAudio from ormma.js:");
	...
	ormma.playVideo = function(URL, properties) {
		console.log("ormma_A-AN-2.0.1.js inside ormma.playVideo from ormma.js:");
		if (!supports[FEATURES.VIDEO]) {
			...
			console.log("ormma_A-AN-2.0.1.js Calling ormma.playVideo in ormma_bridge");
	...
	ormma.createEvent = function(date, title, body) {
		console.log("ormma_A-AN-2.0.1.js inside ormma.createEvent from ormma.js:");
		if (!supports[FEATURES.CALENDAR]) {
			...
			console.log("ormma_A-AN-2.0.1.js Calling ormmaview.createEvent");
			ormmaview.createEvent(date, title, body);
		}
	};

	ormma.getHeading = function() {
		console.log("ormma_A-AN-2.0.1.js inside ormma.getHeading from ormma.js:");
	...
	ormma.getKeyboardState = function() {
		console.log("ormma_A-AN-2.0.1.js inside ormma.getKeyboardState from ormma.js:");
	...
	ormma.getLocation = function() {
		console.log("ormma_A-AN-2.0.1.js inside ormma.getLocation from ormma.js:");
	...
	ormma.getNetwork = function() {
		console.log("ormma_A-AN-2.0.1.js inside ormma.getNetwork from ormma.js:");
