...
(function() {
	...
	vserv.showClose = function() {
		 console.log("inside ormmaview.showClose from ormma_bridge.js:");
		try {
			ORMMADisplayControllerBridge.showClose();
		} catch (e) {
			ormmaview.showAlert("showClose: " + e);
		}
	};
	...
	ormmaview.open = function(URL, controls) {
		...
		try {
			console.log("ormma_bridge_A-AN-2.0.1.js ORMMADisplayControllerBridge.open");
	...
	ormmaview.playVideo = function(URL, properties) {
		console.log("ormma_bridge_A-AN-2.0.1.js inside ormmaview.playVideo from ormma_bridge.js:");
		...
		try {
			console.log("ormma_bridge_A-AN-2.0.1.js inside ormmaview.playVideo from ormma_bridge.js123:");
			clearPostActionNotifyUrl();
			ORMMADisplayControllerBridge.VideoType("ormma");
	...
	ormmaview.createEvent = function(date, eventTitle, eventDetails) {
		console.log("ormma_bridge_A-AN-2.0.1.js inside ormmaview.createEvent from ormma_bridge.js:");
	...
	vserv.playVideo = function(URL, properties) {
		console.log("ormma_bridge_A-AN-2.0.1.js inside vserv.playVideo from ormma_bridge.js:");
		...
		try {
		console.log("ormma_bridge_A-AN-2.0.1.js inside vserv.playVideo from ormma_bridge.js123:");
			clearPostActionNotifyUrl();
			setPostActionNotifyUrl();
			ORMMADisplayControllerBridge.VideoType("vserv");
			ORMMADisplayControllerBridge.playVideo(URL, audioMuted, autoPlay,
					controls, loop, position, startStyle, stopStyle);
