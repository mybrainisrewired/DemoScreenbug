...
public class RecentsVerticalScrollView extends ScrollView implements Callback, RecentsScrollView {
    ...
    class AnonymousClass_4 implements OnLongClickListener {
        ...
        public boolean onLongClick(View v) {
            RecentsVerticalScrollView.this.mCallback.handleLongPress(this.val$view, this.val$view.findViewById(R.id.app_description), this.val$thumbnailView);
            return true;
        }
    }
    ...
    private void update() {
        ...
        while (i < this.mAdapter.getCount()) {
            ...
            OnClickListener anonymousClass_2 = onClickListener;
            RecentsVerticalScrollView recentsVerticalScrollView = this;
            ...
            view.findViewById(R.id.recents_callout_line).setOnTouchListener(noOpListener);
